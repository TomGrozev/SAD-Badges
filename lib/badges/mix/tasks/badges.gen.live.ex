defmodule Mix.Tasks.Badges.Gen.Live do
  ...
  with their respective names and types. See `mix badges.gen.schema`
  ...
  Alternatively, the `--context-app` option may be supplied to the generator:
      ...
      mix badges.gen.live Sales User users --context-app warehouse
  ...
  module name, for example:
      ...
      mix badges.gen.live Sales User users --web Sales
  ...
  use binary ids for primary keys, see `mix badges.gen.schema` for more
  information.
  """
  use Mix.Task
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise "mix badges.gen.live must be invoked from within your *_web application root directory"
    end
  ...
  defp copy_new_files(%Context{} = context, binding, paths) do
    ...
    Mix.Phoenix.copy_from(paths, "priv/templates/badges.gen.live", binding, files)
